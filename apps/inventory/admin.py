...
class InventoryAdmin(admin.ModelAdmin):
    list_display = ('product', 'quantity', 'reserved_quantity', 'available_quantity', 'status', 'last_updated')
    ...
    fieldsets = (
        ...
        ('Stock Levels', {'fields': ('quantity', 'reserved_quantity', 'minimum_stock', 'maximum_stock')}),
        ('Reorder Settings', {'fields': ('reorder_point', 'reorder_quantity')}),
        ('Status', {'fields': ('status', 'warehouse_location', 'shelf_number')}),
        ('Timestamps', {'fields': ('last_updated', 'last_restocked', 'created_at')}),
    )
...
class InventoryReservationAdmin(admin.ModelAdmin):
    list_display = ('inventory', 'order_id', 'quantity', 'status', 'expires_at')
