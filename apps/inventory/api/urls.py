...
urlpatterns = [
    ...
    path(
        "inventory/<uuid:product_id>/adjust-stock/",
    ...
    path(
        "inventory/movements/",
        StockMovementHistoryView.as_view(),
        name="stock-movements",
    ),
    path(
        "inventory/alerts/", StockAlertListView.as_view(), name="stock-alerts"
    ),
    path(
        "inventory/alerts/<uuid:alert_id>/resolve/",
