...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('full_name', 'phone_number', 'profile_picture')}),
        (_('Permissions'), {
        ...
        (_('Security'), {'fields': ('reset_password_token', 'reset_password_expires',
...
class UserActivityLogAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('id', 'user', 'activity_type', 'ip_address', 'user_agent', 'details', 'created_at')
